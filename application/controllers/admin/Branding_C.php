...
//Thanks Page image upload end code 
                ...
                $brandData = array(
                    ...
                    'b_home_t_color' => ($this->input->post('b_home_text_color') != '') ? $this->input->post('b_home_text_color') : null,

                    'b_home_button_text' => ($this->input->post('h_button_text') != '') ? $this->input->post('h_button_text') : null,

                    'b_home_survey_color' => ($this->input->post('survey_color') != '') ? $this->input->post('survey_color') : null,

                    'b_home_logo' => $logo, 'b_home_background' => $background,
...
//device update for branding 
    ...
    public function branding_device() {
        ...
        if ($this->input->post('submit')) {
            ...
            $device_add2 = $this->Survey_model->survey_device($device_id[$i], $device_data);
...
//                                                                                     'restaurant_id'=>$restaurant_id, 
                    ...
                    'b_home_t_color' => ($this->input->post('b_home_text_color') != '')?$this->input->post('b_home_text_color'):$branding->b_home_t_color,

                    'b_home_button_text' => $this->input->post('h_button_text'),

                    'b_home_survey_color' => ($this->input->post('survey_color') != '')?$this->input->post('survey_color'):$branding->b_home_survey_color,
