...
//                        $numMax[$key2];
                ...
                if($this->input->post("customerInfoIsRequired") == "YES") {
                    ...
                    // print_r($contactQuestionArray);

                    // echo "array key last"; 
                    // print_r(array_key_last($question_value['question']));
                    // echo count($question_value['question']);
                    ...
                    /**
                     * @Important Note:-
                     * array_key_last function not supported on server
                     */ 
...
//         $device_id = $this->input->post('device');
    ...
    public function edit($id) {
        ...
        $data['language'] = $this->Survey_model->get_language();
        // echo "<pre>"; print_r(json_decode($data['question'][0]->options)); 
