...
//            $data['branding_logo'] = ($branding->b_home_logo != '')?base_url().'uploads/'.$dat['restaurant_id'].'/'.$branding->b_home_logo: base_url().'image/app_logo.png';
    ...
    public function survey_post(){
         ...
         *@ Hardcoded Data;
         */
        $surveyData['restaurant_id'] = '13';

        $surveyData['survey_id'] = '208';

        $surveyData['device_info'] = $device_imei->device_name;

        $surveyData['device_imei'] = '6151ad6d4a7e2ac6';

        $surveyData['answer_date'] = date('Y-m-d H:i:s');

        $responses['answer_json'] = json_decode('{"response":[{"type":"3","sequence_no":1,"value":3},{"type":"1","sequence_no":2,"value":2.0},{"type":"6","sequence_no":3,"value":3},{"type":"8","sequence_no":4,"value":[{"name":"Staff service","selected":false},{"name":"Accomodation","selected":true},{"name":"Food","selected":false},{"name":"Drinks","selected":false}]},{"type":"11","sequence_no":5,"value":"yes"},{"type":"13","sequence_no":6,"value":""}]}', true);

        $surveyData['answer_json'] = '{"response":[{"type":"3","sequence_no":1,"value":3},{"type":"1","sequence_no":2,"value":2.0},{"type":"6","sequence_no":3,"value":3},{"type":"8","sequence_no":4,"value":[{"name":"Staff service","selected":false},{"name":"Accomodation","selected":true},{"name":"Food","selected":false},{"name":"Drinks","selected":false}]},{"type":"11","sequence_no":5,"value":"yes"},{"type":"13","sequence_no":6,"value":""}]}';
           ...
           $tri_data[] = $data;
            ...
            if($data['trigger_rule'] == 'OR'){
                ...
                if($common == true){
                    ...
                    $survey_name = $this->API_model->survey_name($surveyData['survey_id']);
