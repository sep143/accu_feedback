        ...
        if($this->input->post('submit')){
            ...
            if($this->form_validation->run()== FALSE){
                ...
                if($result){
                    ...
                    $option_code = '{"question_lang":{"lang":{"en":"English"}},"question":[{"sequence_no":"1","type":"2","required":"YES","text":{"en":"Please rate the following:"},"options":{"en":["Food Quality","Menu Variety","Service","Atmosphere"]}},{"sequence_no":"2","type":"11","required":"YES","text":{"en":"Did you receive your order on time?"}},{"sequence_no":"3","type":"6","required":"YES","text":{"en":"How likely are you to visit us again?"}},{"sequence_no":"4","type":"7","required":"YES","text":{"en":"Where did you hear about us?"},"options":{"en":["Friend","Internet","Newspaper","Other"]}},{"sequence_no":"5","type":"5","required":"YES","text":{"en":"Please mention the special days of your life, so we can arrange some offers \/ discounts for you."},"options":{"en":[{"type":"date","label":"Birth date","required":"YES"},{"type":"date","label":"Anniversary date","required":"YES"}]}},{"sequence_no":"6","type":"3","required":"YES","text":{"en":"How was your overall experience with us?"}},{"sequence_no":7,"type":"5","required":"YES","text":{"en":"Enter your contact information."},"options":{"en":[{"type":"text","label":"Enter your full name.","required":"YES"},{"type":"email","label":"Enter your email address.","required":"NO"},{"type":"number","label":"Enter your mobile number.","required":"YES"}]}}]}';
                    ...
                    $survey = array(
                        ...
                        'survey_name'=>'Restaurant Feedback 1',
                    ...
                    $branding = array(
                        ...
                        'b_home_t_color'=>'#000000',

                        'b_home_button_text'=>'Take a survey',

                        'b_home_survey_color'=>'#4fc1e9',
