...
<!--                            <a href="#" class="btn btn-success btn-md">
                ...
                <div class="tab-content tab-space">
                    ...
                    <div class="tab-pane active" id="tablet">
                        <div class="row">
                            ...
                            <div class="col-md-6 center-block" style="max-height: 470px; height: auto;">
                                <div class="carousel-parent-container" data-ride="carousel" data-interval="3000" style="background-image: url('<?= base_url() ?>web/img/admin/tab/tab4.PNG');">
                                    <div class="carousel slide carousel-fade carousel-inner .carousel-inner-style" style="top:15%!important; height: 380px!important; width: 415px!important; position: relative!important; vertical-align: middle!important; text-align: center!important;overflow: visible!important;">
                                        <!-- <img class="carousel-inner-style-img" src="<?= base_url(); ?>web/img/admin/tab/1.png" alt="" style="/*height: 272px; width:372px; top:16%; left:16%; vertical-align: middle; position: absolute;*/"> -->
                                        <div class="item active" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/1.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                        <div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/2.png" alt="" class="carousel-inner-style-img">
                                        </div>
										<div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/3.png" alt="" class="carousel-inner-style-img">
                                        </div>
										<div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/4.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                        <div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/5.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                        <div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/6.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                        <div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/7.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                        <div class="item" >
                                            <img src="<?= base_url(); ?>web/img/admin/tab/8.png" alt="" class="carousel-inner-style-img">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="pricing section-image">
            <div class="container">
                <div class="section-heading text-center">
                    ...
                    <h5 class="description">Sign up today! upgrade or cancel anytime, no question asked.</h5>
                </div>
                    ...
                    <div class="col-sm-4 text-center">
                        <div class="card card-pricing">
                            <div class="content">
                                ...
                                <h2 class="card-title"><small><i class="fa fa-rupee"></i></small>&nbsp;2000<small>/mo</small></h2>
                                <ul>
                                    <li><b>30</b> Days Active</li>
    ...
    <footer class="footer">
        <div class="container footer-widget">
            ...
            <p class="copyright"><i class=""></i> &copy; Accu Feedback 2019 <a class="pull-right" href="<?=base_url('privacypolicy')?>" target="_blank">Privacy Policy</a></p>
        </div>
    </footer>
    <!-- ./Footer section -->
    <!-- End footer -->
