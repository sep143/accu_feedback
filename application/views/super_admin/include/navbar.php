  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?= base_url('super_admin/dashboard');?>" class="logo">
...
<!--          <li class="dropdown tasks-menu">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- Menu Footer-->
              <li class="">
                  <a href="<?= site_url('super_admin/LoginController/logout'); ?>" >Sign out</a>
              </li>
<!--              <li class="">    
                  <a href="<?= site_url('admin/auth/change_pwd'); ?>" >Change Password</a>
              </li>-->
              </ul>
            </ul>
          </li>
