...
<html lang="en">
    ...
    <head>
          ...
          <title><?=isset($title)?$title:'User Management System Super Admin' ?></title>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 text-center">
                ...
                <div class="login-title">
                    ...
                    <h3><span>Super Admin</span>ADMIN & USER MANAGEMENT SYSTEM</h3>
                ...
                <div class="form-box">
                    ...
                    <?php echo form_open(base_url('super_admin/LoginController/login'), 'class="login-form" '); ?>
