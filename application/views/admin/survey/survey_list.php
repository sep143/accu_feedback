    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <h1><span style="font-size: 60px; font-weight: 300; color: black; line-height: 1;"><?= $count; ?><b> ?</b></span></h1>
                </div>
                <!-- /.box-body -->
            </div>
            ...
            <div class="box">
                ...
                <div class="">
                  <a href="<?= site_url('admin/Survey_C/addSurvey'); ?>" >  
                      <button type="button" class="btnMain btn btn-default btn-block"><i class="fa fa-plus"> </i> &nbsp;New Survey</button>
                  </a>
      ...
      <?php foreach ($list as $devices_count=> $devices_data): ?>
        $('#dialog<?= $devices_count; ?>').on('click', function () {
            ...
            $.confirm({
                ...
                icon:'fa fa-warning',
                title: 'Delete Survey',
                content: 'This survey and all associated data will be deleted. This is not reversible.',
                theme: 'modern',
                buttons: {
                    confirm: function () {
                           ...
                           success: function(data){
                               $.confirm({
                                   //animation: 'zoom',
                                    ...
                                    content: 'The selected survey and associated data was deleted.',
                                    theme: 'modern',
                                    buttons:{
                                        Ok: function(){
