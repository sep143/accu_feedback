                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="form-group input-group" style="padding: 19px 17px; background: #eff0f4; margin-top: -20px; margin-right: -21px; margin-left: -21px;">
                                ...
                                <!--<input type="hidden" value="<?= $qes->q_id; ?>" name="question_id[]">-->
                                <textarea class="form-control" rows="2" name="question[<?= $i-1; ?>]" id="qType<?= $Qcount+11; ?>" required=""><?= $json_data['question'][$Qcount]['text']['en']; ?></textarea>
                            ...
                            <?php } endforeach; ?>
                                ...
                                <div class="col-md-5">
                                    <input type="hidden" name="mandatory[<?= $i-1; ?>]" value="NO">
                                <?php if($json_data['question'][$Qcount]['required'] == 'YES'){ ?>
                                    <input type="checkbox" name="mandatory[<?= $i-1; ?>]" class="" value="YES" checked="checked" style="margin: 10px;">
                                    <!--<input type="hidden" name="mandatory[<?= $i-1; ?>]" value="YES">-->
                                <?php }else{ ?>
                                      <input type="checkbox" name="mandatory[<?= $i-1; ?>]" class="" value="YES" style="margin: 10px;">
                             ...
                             if($ch2 == 13 || $ch2 == 14 || $ch2 == 15) { ?>
                                <div class=""><br>
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="number" value="<?= set_value('numMin[]',$json_data['question'][$Qcount]['min_range']); ?>" name="numMin[<?= $i-1 ?>]" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="number" value="<?= set_value('numMax[]',$json_data['question'][$Qcount]['max_range']); ?>" name="numMax[<?= $i-1 ?>]" class="form-control" >
                                        </div>
                                    </div>
                                </div>
        ...
        $(add_button).click(function (e) { //on add input button click
           ...
           z = divLen+<?= $qi+1; ?>;
            ...
            if (x) { //max input box allowed
                ...
                <div class="col-md-7">\n\
                    <div class="box iBox">\n\
                    <a href="" id="remove_field" class="fa fa-plus pull-right"></a>\n\
                         <div class="box-body">\n\
                            <div class="form-group input-group" style="padding: 19px 17px; background: #eff0f4; margin-top: -20px; margin-right: -21px; margin-left: -21px;">\n\
                                <div class="input-group-addon order" style="background: #9c9cb0; color: white;">'+z+'</div>\n\
                                <textarea class="form-control" rows="2" name="question['+ q_id +']" id="qType'+x+'" required=""></textarea>\n\
                            ...
                            <div class="col-md-12">\n\
                                ...
                                <div class="col-md-5">\n\
                                    <input type="hidden" name="mandatory['+q_id+']" value="NO"><input type="checkbox" name="mandatory['+ q_id +']" class="" value="YES">\n\
                                    <label class="">Mandatory</label>\n\
                                </div>\n\
                            </div>\n\
