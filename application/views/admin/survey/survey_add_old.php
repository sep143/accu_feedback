        ...
        <div class="col-md-12">
            ...
            <div class="" >
                ...
                <div class="col-md-7">
                    <div class="box">
                        <div class="box-body">
                            <div class="form-group input-group" style="padding: 19px 17px; background: #e5e6e6; margin-top: -20px; margin-right: -21px; margin-left: -21px;">
                ...
                if(selectOption == 1 || selectOption == 3 || selectOption == 6 || selectOption == 11){
                    ...
                    $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+a+'" class="input-group" style="margin:10px;"><input class="form-control" id="optionText'+id+a+'" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                     ...
                     $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                            ...
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+b+'" class="input-group" style="margin:10px;"><input class="form-control" id="optionText'+id+b+'" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                           // alert('One options');
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+c+'" class="input-group" style="margin:10px;"><input id="optionText'+id+c+'" class="form-control" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+d+'" class="input-group" style="margin:10px;"><input id="optionText'+id+d+'" class="form-control" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+e+'" class="input-group" style="margin:10px;"><input id="optionText'+id+e+'" class="form-control" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option"+id).html('<div id="options_del'+id+'" class="form-group">\n\
                        ...
                        $("#addDiv"+id).click(function() {
                            $("#viewDiv"+id).append('<div id="viewDivDel'+id+f+'" class="input-group" style="margin:10px;"><input id="optionText'+id+f+'" class="form-control" type="text" name="optionName['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $('#metrix'+id).html('<div id="metrix_del'+id+'"> <div class="">\n\
                        ...
                        $('#matrixQuAdd'+id).click(function(){
                            $('#matrixQuView'+id).append('<div id="matrixRow'+id+h+'" class="input-group" style="margin:10px;"><input id="optionText'+id+h+'" class="form-control" type="text" name="optionMetrix['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                      ...
                      //matrix in column Add
                        $('#matrixAnsAdd'+id).click(function() {
                            $('#matrixAnsView'+id).append('<div id="matrixCol'+id+hh_n+'" class="input-group" style="margin:10px;"><input id="columnText'+id+hh_n+'" class="form-control" type="text" name="metrixAnswer['+ counter1 +'][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                            if(hh_n > 11){
                ...
                if(selectOption1 == 1 || selectOption1 == 3 || selectOption1 == 6 || selectOption1 == 11){
                  ...
                  $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                            $("#viewDiv1").append('<div id="viewDiv'+id+aa+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+aa+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button type="button" class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                           // alert('M-Smily');
                            $("#viewDiv1").append('<div id="viewDivDel'+id+bb+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+bb+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                   ...
                   $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                           // alert('One Options');
                            $("#viewDiv1").append('<div id="viewDivDel'+id+cc+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+cc+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                            $("#viewDiv1").append('<div id="viewDivDel'+id+dd+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+dd+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                   ...
                   $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                            $("#viewDiv1").append('<div id="viewDivDel'+id+ee+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+ee+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                    ...
                    $("#select_type_option").html('<div id="select_div_del" class="form-group">\n\
                        ...
                        $("#addDiv1").click(function() {
                            $("#viewDiv1").append('<div id="viewDivDel'+id+ff+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+ff+'" class="form-control" type="text" name="optionName[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                ...
                $('#DataField').html('<div id="DataField_del">\n\
                    ...
                    $('#metrix').html('<div id="metrix_del">\n\
                        ...
                        $('#matrixQuAdd').click(function(){
                            $('#matrixQuView1').append('<div id="matrix'+id+hh+'" class="input-group" style="margin:10px;"><input id="optionTextf'+id+hh+'" class="form-control" type="text" name="optionMetrix[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                      ...
                      //matrix in column Add
                        $('#matrixAnsAdd').click(function() {
                            $('#matrixAnsView1').append('<div id="matrixColumn'+id+hhh+'" class="input-group" style="margin:10px;"><input id="columnTextf'+id+hhh+'" class="form-control" type="text" name="metrixAnswer[0][]" placeholder="" /><span class="input-group-btn"><button class="btn btn-default btn-info" id="dltOption">X</button></span></div>');
                            if(hhh > 11){
