										...
										<tbody>
											...
											<tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
												<td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; vertical-align:top; margin:0; padding:0 0 20px" valign="top">&nbsp;<br>&nbsp;<br>
                                                     <a href="<?= base_url();?>admin/LoginController/reset_password/<?= $temp_pass.$temp_key; ?>" style="padding:15px 20px; border-radius:10px; background-color:#3aaed9; text-decoration:none; color:#fff" target="_blank" data-saferedirecturl="">Reset Password</a>
												    &nbsp;<br>&nbsp;<br>
												</td>
											</tr>
											<tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
						...
						<tbody>
							<tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
								<td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:12px; vertical-align:top; color:#999; text-align:center; margin:0; padding:0 0 20px" align="center" valign="top">
								     You're receiving this email because you have an account on Elegant Surveys. <br>
									<a style="text-decoration:underline; color:#999">Unsubscribe</a> to stop receiving these emails.<br style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0"></td>
							</tr>
						</tbody>
					</table>
				</div>
