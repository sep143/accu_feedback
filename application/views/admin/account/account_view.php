            ...
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>After the free evaluation, Accu Feedback is billed depending the number of devices connected.</p>

                        <label></label>

                        <div class="">

                            <a href="<?= site_url('admin/payment/upgrade'); ?>" class="btn btn-success" disabled="disabled">View Plan / Upgrade  <i class="fa fa-chevron-right"></i></a>
