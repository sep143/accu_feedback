...
<?php 
    ...
    if($json_question['question'][$Qcount]['sequence_no'] == ($Qcount+1)){
       ...
       if($ch_type == 1){
    ?>
<div data-v-0775d61a="" class="col-lg-6 col-md-6">
...
<?php  }else if($ch_type == 2){ ?>
           <div data-v-0775d61a="" class="col-lg-6 col-md-6">
                <div data-v-0775d61a="" class="card">
                    ...
                    <div data-v-0775d61a="" class="card-body question-chart-body">
                        <div id="MultiStar<?= $Qcount; ?>" style="min-width: 290px; height: 400px; width: 500px; margin: 0 auto;"></div>
                    </div>
                </div>
            </div>
...
<?php }else if($ch_type == 4){ ?>
      <div data-v-0775d61a="" class="col-lg-6 col-md-6">
                <div data-v-0775d61a="" class="card">
                    ...
                    <div data-v-0775d61a="" class="card-body question-chart-body">
                        <div id="MultiSmiley<?= $Qcount; ?>" style="min-width: 250px; height: 400px; width: 500px; margin: 0 auto;"></div>
                    </div>
                </div>
            </div>
