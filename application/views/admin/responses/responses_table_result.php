...
//                endforeach; //response loop end
               ...
               // echo "<pre>"; print_r($json_table['response']);
               // echo sizeof($json_table['response']);
...
//                    if($q_seq[$j_count] == $json_table['response'][$j_count]['sequence_no']){
                  ...
                  // echo $q_id;
                  echo ""; $json_table['response'][$j_count]['sequence_no'];
               ...
               endforeach; 
                   ...
                   echo ($json_table['response'][$j_count]['value'])?$json_table['response'][$j_count]['value']:'-';
              ...
              //question wise responses view
               ...
               // for($j=sizeof($json_table['response']);$j<=$total_question;$j++) {
              ...
              // if($j==$total_question) {  
                    ...
                    $obtain = ((int)$star + (int)$smiley + (int)$nps + (int)$mstar);
                     ...
                     // echo "Size= " .sizeof($json_table['response']);
                     // echo "Total Question = ". ($total_question-1);
