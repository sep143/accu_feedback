...
<div class="col-md-12"> 
            ...
            <div class="">
                ...
                <div class="box">
                 ...
                 <?php echo form_open(base_url('admin/Branding_C/branding_device'), 'class=""');  ?>  

                    <input type="hidden" value="<?= $b_id; ?>" name="branding_id">

                    <div class="box-body">

                        <label style="font-size-adjust: 10px; font-size: 15px;">Would you like to enable the feedback <strong>"<?= $branding_name; ?>"</strong> on any of your devices? <br>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div><input type="submit" name="submit" value="Update" class="btn btn-default">
                                    ...
                                    <a class="" href="<?= site_url('admin/Branding_C'); ?>" style="padding: 10px; cursor: pointer;"> Skip <i class="fa fa-forward"></i></a></div>
                            ...
                            <?php } else{ ?>
                                ...
                                <a class="" href="<?= site_url('admin/Branding_C'); ?>" style="padding: 10px; cursor: pointer;"> Skip <i class="fa fa-forward"></i></a>
