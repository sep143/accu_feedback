                ...
                <div class="box">
                 ...
                 <?php echo form_open(base_url('admin/Survey_C/survey_device'), 'class=""');  ?>  
                    ...
                    <div class="box-body">
                        ...
                        <label style="font-size-adjust: 10px; font-size: 15px;">Would you like to enable the feedback <strong>"<?= $survey_name; ?>"</strong> on any of your devices? <br>
                            ...
                            <div class="col-md-12">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div><input type="checkbox" name="device[]" value="<?= $d_data->device_id; ?>" class="form-cont" size="2" <?=in_array($s_id, json_decode($d_data->survey_id))?'checked':''?>> <strong><?= $d_data->device_name; ?></strong></div>
