            ...
            <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-lg-6 col-xs-12">
                            ...
                            <label class=""><b>Device IMEI</b> - <small><i><?= $device_data->device_imei; ?></i></small></label>
                        ...
                        &nbsp;<br>
                         ...
                         <div class="">
                             ...
                             <label class="float-left h-25"><b>Feedback</b></label>

                         </div>

                        <?php if($adminRole == 2 || $otherRole == 11){ 

                            $set_survey_id = json_decode($device_data->survey_id, true);

                                $lang_count = (sizeof($set_survey_id));

//                                print_r($lang_count);

                            ?>

                        <select class="form-control select2" name="survey_id[]" multiple="multiple" data-placeholder="Select a Surveys">

                            <?php 

                            $lang_set = 0;

                                foreach ($allSurvey as $s_count => $s_data): 

                                    

                                    ?>

                                    <option value="<?= $s_data->survey_id; ?>" 

                                    <?php

                                    // if($lang_count > $lang_set){

                                        echo ($set_survey_id[$lang_set] == $s_data->survey_id)?'selected="selected"':'';
                            ...
                            if($set_survey_id[$lang_set] == $s_data->survey_id){
