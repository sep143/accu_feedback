...
<!--            <div class="" style="display: none;" id="scr">
                <input type="number" id="condition_value" size="30" class="form-control" required="" value="<?= set_value('','4'); ?>">
            </div>
            <div class="" id="ans">
                <select class="form-control" id="condition_value">
        ...
        <script>
            $('#lastDiv').html('<select class="form-control" id="condition_value">\n\
                    <option value="1">1 Star</option>\n\
                    <option value="2">2 Star</option>\n\
                    <option value="3" selected="">3 Star</option>\n\
                    <option value="4">4 Star</option>\n\
            ...
            $('select[id^="type1AS"]').on('change',function(){
                ...
                if(val == 'answer'){
                    ...
                    $('#lastDiv').html('<input type="number" id="condition_value" size="30" class="form-control" required="" value="<?= set_value('','4'); ?>">');
                }
            });
        </script>
    </div>
        ...
        <script>
            ...
            $('select[id^="type3AS"]').on('change',function(){
                ...
                if(val == 'answer'){
                   ...
                   $('#lastDiv').html('<input type="number" id="condition_value" size="30" name="" class="form-control" required="" value="<?= set_value('','4'); ?>">');
                }
            });
        </script>
    </div>
        ...
        <script>
            ...
            $('select[id^="type6AS"]').on('change', function(){
                ...
                if(val == 'answer'){
                    ...
                    $('#lastDiv').html('<input type="number" id="condition_value" size="30" class="form-control" required="" value="<?= set_value('','5'); ?>">');
                }
            });
        </script>
