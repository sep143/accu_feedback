...
<!--                                        <a href="<?= site_url('admin/Notifications_C/view_responses/'.$n->t_id); ?>">View Response</a>-->
                                    ...
                                    &nbsp;
                                    <span style="cursor: pointer;" id="dialog<?=$row;?>" data-id="<?=$n->t_id;?>"><i class="fa fa-trash-o" style="color:red; font-size: 20px;"></i></span>
...
<script>
  ...
  <?php foreach ($notification as $row=>$n): ?>
   
    $('#dialog<?= $row; ?>').on('click', function () {
   
            var value = $('#dialog<?= $row; ?>').attr("data-id");
                ...
                buttons: {
                    ...
                    confirm: function () {
                       ...
                       $.ajax({
                           ...
                           url:'<?= site_url('admin/Notifications_C/notification_delete'); ?>',
   
                           type:'post',
   
                           data:{'<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo
                            $this->security->get_csrf_hash(); ?>', notification_id:value},
                           ...
                           success: function(data){
                               ...
                               $.confirm({
                                   ...
                                   //animation: 'zoom',
                                    ...
                                    content: 'The selected notification was deleted.',
