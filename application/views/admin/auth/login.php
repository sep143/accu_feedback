        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 ">
                ...
                <div class="login-title text-center">
                    ...
                    <span>Accu Feedback</span>Login to your account
                ...
                <div class="form-box text-center">
                    ...
                    <div class="caption">
                        ...
                        <h4><i class="icon fa fa-user-circle"></i></h4>

                    </div>

                    <?php echo form_open(base_url('admin/LoginController/login'), 'class="login-form" '); ?>
